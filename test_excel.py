...
async def run_test():
    file_path = os.path.join("app", "test-stuff", "Arabian Ranches New  (1) (1) (1).xlsx")
    notebook_id = "nb_excel_test_001"
    
    print(f"\n{'='*60}")
    print(f"VECTOR INGESTION TEST: EXCEL")
    ...
    try:
        ...
        # Since Excel rows are merged into strings "Col1: Val1 | Col2: Val2", we can search for a keyword
        query = "Show me rows related to Arabian Ranches"
